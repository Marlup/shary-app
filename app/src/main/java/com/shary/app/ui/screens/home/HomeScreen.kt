...
import com.shary.app.ui.screens.fields.SendFieldsDialog
import com.shary.app.ui.screens.ui_utils.AppTopBar

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun HomeScreen(navController: NavHostController, session: Session) {

    // +++++ Selection Summary +++++
    var emailsNotEmpty by remember { mutableStateOf(false) }
    var fieldsNotEmpty by remember { mutableStateOf(false) }
    ...
    // Run at launch
    LaunchedEffect(Unit) {
        emailsNotEmpty = session.selectedEmails.value.isNotEmpty()
        fieldsNotEmpty = session.selectedFields.value.isNotEmpty()
    }
    ...
    Scaffold(
        ...
        Column {
            ...
            if (emailsNotEmpty && fieldsNotEmpty) {
